        ...
        <div className="hidden md:flex md:w-[45%] relative flex-col min-h-[580px]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <p className="text-sm text-white/85 leading-snug">
              Professional grooming that feels like a warm hug for your best
              friend.
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 p-10 md:p-14 relative">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">
              Sign in to book your pet&apos;s next spa day.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* UI kept exactly as your original design */}
            ...
            <button
              ...
              className="w-full py-3 bg-[#4a6741] text-white text-sm font-semibold rounded-lg hover:bg-[#3d5736] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
